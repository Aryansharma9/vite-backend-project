...
//             const updateResponse = await fetch('http://localhost:5000/api/athletes', {
//                 method: 'POST',
//                 headers: { 'Content-Type': 'application/json' },
...
//                 {user ? (
//                     <>
//                         <Header onLogout={handleLogout} user={username} onNavigate={setCurrentPage} currentPage={currentPage} />
...
//                             )
//                         ) : (
//                             <LeaderboardPage athletes={athletes} />
//                         )}
//                     </>
//                 ) : (
//                     <AuthScreen
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.userType === 'athlete') {
                    const athleteResponse = await fetch(`http://localhost:5000/api/athletes/${data.userId}`);
